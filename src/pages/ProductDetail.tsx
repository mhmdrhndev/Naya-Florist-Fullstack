          ...
          <div className="lg:col-span-5 flex flex-col gap-6 lg:sticky lg:top-24">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                ...
                className="flex-1 h-14 border border-primary text-primary hover:bg-primary/5 transition-all duration-300 rounded-full font-label-caps text-xs uppercase tracking-widest font-bold flex items-center justify-center gap-2 cursor-pointer"
              >
                <svg
                  viewBox="0 0 32 32"
                  width="18"
